...
class SubscribersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post subscribers_url, params: { subscriber: { age: @subscriber.age, country: @subscriber.country, name: @subscriber.name } }
    end
  ...
  test "should update subscriber" do
    patch subscriber_url(@subscriber), params: { subscriber: { age: @subscriber.age, country: @subscriber.country, name: @subscriber.name } }
